...
urlpatterns = [
    ...
    path("web/receive_code/",web_receive_code,name="settings_acwing_web_recevie_code"),
    path("acapp/apply_code/",acapp_apply_code,name="settings_acwing_acapp_apply_code"),
    path("acapp/receive_code/",acapp_receive_code,name="settings_acwing_acapp_recevie_code"),
]
